 ...
 */
package uk.ac.sussex.ianw.fp.futoshiki.text;
...
public class Command {
    ...
    /**
     * If we have a command that operated on a vlaue, instantiate
     *
     * @param column
     */
    ...
    /**
     * Principally to be used to set a value of the Futoshiki square
     *
     * @return the value
     */
        public int getValue() {
